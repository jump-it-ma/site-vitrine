...
import { ibmCondensedFont } from "@/utils/fonts";
...
export default function Navbar({}: Props) {
  ...
  return (
    <div
      className={
        ibmFont.className +
        " flex justify-center items-center w-full bg-white box-shadow sticky top-0 z-50"
      }
    >
      <div className="flex justify-between items-center w-11/12 lg:w-10/12 gap- xl:gap-8">
        ...
        <div
          ...
          className="xm:hidden relative border-2 border-ac-violet rounded-md cursor-pointer"
        >
          <HiMenuAlt2 size={35} color="#644E9B" />
        </div>
        <div
          className={`xm:hidden flex justify-start items-center absolute top-20 left-0 w-full bg-white transition ${
            showMenu
        ...
        <div className="flex justify-center items-center gap-4">
          ...
          <Link href={"/contactez-nous"}>
            <div className="hidden xm:flex justify-center items-center bg-purple-600 rounded-full gap-1 py-2.5 px-5 w-fit cursor-pointer">
              <p className="text-base uppercase font-bold text-center text-white whitespace-nowrap select-none">
                Contactez-nous
              </p>
              <HiOutlineArrowRight size={25} color="white" />
            </div>
