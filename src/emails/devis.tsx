      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              L&apos;utilisateur <b>{fullname}</b> affilié avec
              l&apos;entreprise <b>{entreprise}</b> a demandé une demande de
              devis pour la formation <b>{formation}</b> à commencer le{" "}
            ...
            <Text style={indentparagraph}>
              ...
              <b style={{ fontSize: "16px", fontWeight: "bold" }}>
                {Math.ceil(duration / dailyHours)} jours ({duration} heures)
              </b>
            </Text>
